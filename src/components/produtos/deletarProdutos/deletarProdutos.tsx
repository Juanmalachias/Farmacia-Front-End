...
function DeletarProdutos() {
    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            <p className='text-center font-semibold mb-4'>Você tem certeza de que deseja apagar esse produto a seguir?</p>

            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                <header className='py-2 px-6 bg-indigo-600 text-white font-bold text-2xl'>Produtos</header>
                <div className="p-4">
                    <p className='text-xl h-full'>{produtos.nome}</p>
